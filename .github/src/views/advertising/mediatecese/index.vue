...
import { allOrderList } from "@/api/mediationorders";
import { selectList , cpeList} from "@/api/comment";
...
export default {
  ...
  methods: {
    ...
    getSelect() {
      ...
      cpeList(paramst).then(res=>{
        this.data.cpeList = res.data
      })
    },
    //获取调解工单列表
    allOrderList() {
